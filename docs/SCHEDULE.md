...
| 항목          | 값                                                   |
| ------------- | ---------------------------------------------------- |
| 최근 갱신     | 2026-05-22 09:25                                     |
| 현재 단계     | OD toolbar idx 매핑 완료 (idx=0='Pre-Defined Index') |
| 진행률        | 40/42 (95.2%)                                        |
| 마지막 commit | `4ec93ab` OD toolbar 첫 버튼 (left=227) 인식         |
...
| 일자       | 작업                                                                | 결과 | Commit    |
| ---------- | ------------------------------------------------------------------- | ---- | --------- |
| 2026-05-22 | OD idx 0~6 매핑 확정 (idx=0='Pre-Defined Index', 5/6=Import/Export) | ✓    | (probe)   |
| 2026-05-22 | OD toolbar TOOLBAR_X_MIN 260→220 (첫 버튼 left=227)                 | ✓    | `4ec93ab` |
...
| 우선 | 분류       | 작업                                                                                      | 예상시간 |
| ---- | ---------- | ----------------------------------------------------------------------------------------- | -------- |
| ★★★  | OD recipe  | OD_ACTION_MAP 재구성 (idx=0=Pre-Defined / 5=Import / 6=Export / 1,2 row req)              | 1h       |
| ★★   | 다이얼로그 | 'Pre-Defined Index' 다이얼로그 내부 probe (Variable/Array/Record 선택 위치)               | 1h       |
| ★★   | 다이얼로그 | OD Add Index — Variable/Array/Record 3종 타입 시드 (사용자 요청)                          | 3h       |
