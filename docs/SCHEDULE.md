...
| ------------- | --------------------------------------------------- |
| 최근 갱신     | 2026-05-20                                          |
| 현재 단계     | OD/PDO/Diag 핸들러 완료, 야간 18:00 자동 실행 대기  |
| 진행률        | 22/24 (91.7%)                                       |
| 마지막 commit | `cac6f43` OD 핸들러 + 행 선택 동적 toolbar (D 회복) |
...
| ★    | Edge case   | C diag_cycle_max — Cycle time 행 Edit 1개만 (sort-by-x candidates[1] None)               | 30분     |
