...
| 문서                               | 내용                                                               |
| ---------------------------------- | ------------------------------------------------------------------ |
| [FunctionScan.md](FunctionScan.md) | 기능 스캔 프로젝트 — Clarify·Context Gather·Plan·Generate·Evaluate |

## 개발 규칙

- Python `.py` 스크립트는 프로젝트 내 `skills/` 폴더에 생성한다.
...
프로젝트 파일 구조 상세 → [FunctionScan.md](FunctionScan.md)
